...
class BuiltinImporter:
    ...
    def module_repr(module):
        ...
        """
        _warnings.warn(
            "BuiltinImporter.module_repr() is deprecated and "
    ...
    def find_module(cls, fullname, path=None):
        ...
        """
        _warnings.warn(
            "BuiltinImporter.find_module() is deprecated and "
...
class FrozenImporter:
    ...
    def module_repr(m):
        ...
        """
        _warnings.warn(
            "FrozenImporter.module_repr() is deprecated and "
            "slated for removal in Python 3.12",
            DeprecationWarning,
        )
    ...
    def find_module(cls, fullname, path=None):
        ...
        """
        _warnings.warn(
            "FrozenImporter.find_module() is deprecated and "
            "slated for removal in Python 3.12; use find_spec() instead",
            DeprecationWarning,
        )
...
def _find_spec_legacy(finder, name, path):
    msg = (
        f"{_object_name(finder)}.find_spec() not found; "
...
def _find_and_load(name, import_):
    ...
    if module is _NEEDS_LOADING or getattr(
