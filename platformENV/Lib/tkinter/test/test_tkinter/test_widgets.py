...
class MenubuttonTest(AbstractLabelTest, unittest.TestCase):
    ...
    def test_configure_direction(self):
        widget = self.create()
        self.checkEnumParam(
            widget, "direction", "above", "below", "flush", "left", "right"
        )
...
class SpinboxTest(EntryTest, unittest.TestCase):
    ...
    def test_configure_from(self):
        ...
        self.checkInvalidParam(
            widget, "from", 200, errmsg="-to value must be greater than -from value"
        )
    ...
    def test_configure_to(self):
        ...
        self.checkInvalidParam(
            widget, "to", -200, errmsg="-to value must be greater than -from value"
        )
    ...
    def test_configure_values(self):
        ...
        self.checkParam(
            widget, "values", ("mon", "tue", "wed", "thur"), expected="mon tue wed thur"
        )
        self.checkParam(
            widget,
            "values",
...
class TextTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def test_configure_endline(self):
        ...
        self.checkInvalidParam(
            widget, "endline", "spam", errmsg='expected integer but got "spam"'
        )
    ...
    def test_configure_selectborderwidth(self):
        ...
        self.checkPixelsParam(
            widget, "selectborderwidth", 1.3, 2.6, -2, "10p", conv=False
        )
    ...
    def test_configure_startline(self):
        ...
        self.checkInvalidParam(
            widget, "startline", "spam", errmsg='expected integer but got "spam"'
        )
    ...
    def test_configure_tabs(self):
        ...
        self.checkParam(
            widget, "tabs", "10.2 20.7 1i 2i", expected=("10.2", "20.7", "1i", "2i")
        )
        self.checkParam(
            widget,
            "tabs",
        ...
        self.checkInvalidParam(
            widget, "tabs", "spam", errmsg='bad screen distance "spam"'
        )
...
class CanvasTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def test_configure_offset(self):
        ...
        self.checkParams(
            widget, "offset", "n", "ne", "e", "se", "s", "sw", "w", "nw", "center"
        )
    ...
    def test_configure_scrollregion(self):
        ...
        self.checkParam(
            widget, "scrollregion", (0, 0, 200, 150), expected="0 0 200 150"
        )
        self.checkParam(widget, "scrollregion", "")
        self.checkInvalidParam(
            widget, "scrollregion", "spam", errmsg='bad scrollRegion "spam"'
        )
    ...
    def test_configure_xscrollincrement(self):
        widget = self.create()
        self.checkPixelsParam(
            widget, "xscrollincrement", 40, 0, 41.2, 43.6, -40, "0.5i"
        )

    def test_configure_yscrollincrement(self):
        widget = self.create()
        self.checkPixelsParam(
            widget, "yscrollincrement", 10, 0, 11.2, 13.6, -10, "0.1i"
        )
    ...
    def test_create_line(self):
        ...
        self._test_option_joinstyle(
            c, lambda **kwargs: c.create_line(20, 30, 40, 50, 60, 10, **kwargs)
        )
        self._test_option_smooth(
            c, lambda **kwargs: c.create_line(20, 30, 60, 10, **kwargs)
        )
    ...
    def test_create_polygon(self):
        ...
        self._test_option_joinstyle(
            c, lambda **kwargs: c.create_polygon(20, 30, 40, 50, 60, 10, **kwargs)
        )
        self._test_option_smooth(
            c, lambda **kwargs: c.create_polygon(20, 30, 40, 50, 60, 10, **kwargs)
        )
...
class ListboxTest(AbstractWidgetTest, unittest.TestCase):
    ...
    test_configure_justify = requires_tk(8, 6, 5)(
        StandardOptionsTests.test_configure_justify
    )
    ...
    def test_itemconfigure(self):
        ...
        self.assertEqual(
            widget.itemconfigure(0, "background"),
            ("background", "background", "Background", "", "red"),
        )
        self.assertEqual(
            widget.itemconfigure("end", "background"),
            ("background", "background", "Background", "", "violet"),
        )
        self.assertEqual(
            widget.itemconfigure("@0,0", "background"),
            ("background", "background", "Background", "", "red"),
        )
...
class ScaleTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def test_configure_tickinterval(self):
        widget = self.create()
        self.checkFloatParam(widget, "tickinterval", 1, 4.3, 7.6, 0, conv=float_round)
        self.checkParam(widget, "tickinterval", -2, expected=2, conv=float_round)

    def test_configure_to(self):
        widget = self.create()
        self.checkFloatParam(widget, "to", 300, 14.9, 15.1, -10, conv=float_round)
...
class PanedWindowTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def test_configure_handlesize(self):
        widget = self.create()
        self.checkPixelsParam(widget, "handlesize", 8, 9.4, 10.6, -3, "2m", conv=False)

    def test_configure_height(self):
        widget = self.create()
        self.checkPixelsParam(
            widget, "height", 100, 101.2, 102.6, -100, 0, "1i", conv=False
        )
    ...
    def test_configure_proxyborderwidth(self):
        widget = self.create()
        self.checkPixelsParam(
            widget, "proxyborderwidth", 0, 1.3, 2.9, 6, -2, "10p", conv=False
        )
    ...
    def test_configure_sashwidth(self):
        widget = self.create()
        self.checkPixelsParam(widget, "sashwidth", 10, 11.1, 15.6, -3, "1m", conv=False)
    ...
    def test_configure_width(self):
        widget = self.create()
        self.checkPixelsParam(
            widget, "width", 402, 403.4, 404.6, -402, 0, "5i", conv=False
        )
...
class MenuTest(AbstractWidgetTest, unittest.TestCase):
    ...
    def test_configure_type(self):
        widget = self.create()
        opts = (
            "normal, tearoff, or menubar"
            if widget.info_patchlevel() < (8, 7)
            else "menubar, normal, or tearoff"
        )
        self.checkEnumParam(
            widget,
            "type",
