...
class Test_TextTestResult(unittest.TestCase):
    ...
    def testGetSubTestDescriptionWithoutDocstringAndParams(self):
        with self.subTest():
            ...
            self.assertEqual(
                ...
                "("
                + __name__
                + ".Test_TextTestResult.testGetSubTestDescriptionWithoutDocstringAndParams) "
                "(<subtest>)",
            )
    ...
    def testGetSubTestDescriptionForFalsyValues(self):
        ...
        for arg in [0, None, []]:
            with self.subTest(arg):
                self.assertEqual(
                    result.getDescription(self._subtest), expected % (__name__, arg)
                )
        ...
        with self.subTest(foo=1):
            with self.subTest(baz=2, bar=3):
                ...
                self.assertEqual(
                    ...
                    "("
                    + __name__
                    + ".Test_TextTestResult.testGetNestedSubTestDescriptionWithoutDocstring) "
                    "(baz=2, bar=3, foo=1)",
                )
        ...
        with self.subTest(foo=1, bar=2):
            with self.subTest(baz=3, bar=4):
                ...
                self.assertEqual(
                    ...
                    "("
                    + __name__
                    + ".Test_TextTestResult.testGetDuplicatedNestedSubTestDescriptionWithoutDocstring) (baz=3, bar=4, foo=1)",
                )
    ...
    def testGetDescriptionWithOneLineDocstring(self):
        ...
        self.assertEqual(
            ...
            (
                ...
                "("
                + __name__
                + ".Test_TextTestResult.testGetDescriptionWithOneLineDocstring)\n"
                "Tests getDescription() for a method with a docstring."
            ),
        )
        ...
        with self.subTest(foo=1, bar=2):
            self.assertEqual(
                ...
                (
                    ...
                    "("
                    + __name__
                    + ".Test_TextTestResult.testGetSubTestDescriptionWithOneLineDocstring) "
                    "(foo=1, bar=2)\n"
                    "Tests getDescription() for a method with a docstring."
                ),
            )
    ...
    def testGetDescriptionWithMultiLineDocstring(self):
        ...
        self.assertEqual(
            ...
            (
                ...
                "("
                + __name__
                + ".Test_TextTestResult.testGetDescriptionWithMultiLineDocstring)\n"
        ...
        with self.subTest(foo=1, bar=2):
            self.assertEqual(
                ...
                (
                    ...
                    "("
                    + __name__
                    + ".Test_TextTestResult.testGetSubTestDescriptionWithMultiLineDocstring) "
                    "(foo=1, bar=2)\n"
                    "Tests getDescription() for a method with a longer "
                    "docstring."
                ),
    ...
    def testLongOutput(self):
        ...
        self.assertEqual(
            self._run_test("testSuccess", 2),
            f"testSuccess ({classname}.testSuccess) ... ok\n",
        )
        self.assertEqual(
            self._run_test("testSkip", 2),
            f"testSkip ({classname}.testSkip) ... skipped 'skip'\n",
        )
        self.assertEqual(
            self._run_test("testFail", 2), f"testFail ({classname}.testFail) ... FAIL\n"
        )
        self.assertEqual(
            self._run_test("testError", 2),
            f"testError ({classname}.testError) ... ERROR\n",
        )
        self.assertEqual(
            self._run_test("testExpectedFailure", 2),
            f"testExpectedFailure ({classname}.testExpectedFailure) ... expected failure\n",
        )
        self.assertEqual(
            self._run_test("testUnexpectedSuccess", 2),
    ...
    def testLongOutputSubTestSuccess(self):
        classname = f"{__name__}.{self.Test.__qualname__}"
        self.assertEqual(
            self._run_test("testSubTestSuccess", 2),
    ...
    def testLongOutputSubTestMixed(self):
        classname = f"{__name__}.{self.Test.__qualname__}"
        self.assertEqual(
            self._run_test("testSubTestMixed", 2),
